...
- Can play read-only songs, but cannot edit their tempo, count-in, loop settings, measure numbering, or sequence until unlocking them or duplicating an editable copy.
